...
namespace DisableCrosshairBZ
{
    ...
    public static class CrosshairMenu
    {
        ...
        public static void AddGerneralTab_Postfix(uGUI_OptionsPanel __instance)
        {
            ...
            __instance.AddToggleOption(0, "While Piloting Seatruck", CrosshairOptions.NoCrosshairInSeatruck, (bool v) => CrosshairOptions.NoCrosshairInSeatruck = v);
            __instance.AddToggleOption(0, "While in Prawn Suit", CrosshairOptions.NoCrosshairInPrawnSuit, (bool v) => CrosshairOptions.NoCrosshairInPrawnSuit = v);
